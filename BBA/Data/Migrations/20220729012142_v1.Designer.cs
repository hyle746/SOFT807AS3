            ...
            modelBuilder.Entity("BBA.Models.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "1cfeb72d-5d8a-46f8-9ce6-fbc0bcd99f5d",
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "bcb818e1-99ef-4260-b1f9-2410f09de950",
                            Email = "admin@bba.co.nz",
                            EmailConfirmed = true,
                            LockoutEnabled = false,
                            NormalizedEmail = "ADMIN@BBA.CO.NZ",
                            NormalizedUserName = "ADMIN@BBA.CO.NZ",
                            PasswordHash = "AQAAAAEAACcQAAAAENi2PlElJGUfeH+tY6xFmtSO0sX5kMBL+EDUE+7Hhb9djL7ZDcm/TkRM1XZAqbFedQ==",
                            PhoneNumber = "123456789",
                            PhoneNumberConfirmed = true,
                            SecurityStamp = "22b39969-57db-4cc9-810c-b78c8d90bafe",
                            TwoFactorEnabled = false,
                            UserName = "admin@bba.co.nz"
                        },
                        new
                        {
                            Id = "ccf54229-2819-42eb-bd10-81254f86034f",
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "06c202bb-12c4-4bf6-8d4d-f0fa220af411",
                            Email = "customer@bba.co.nz",
                            EmailConfirmed = true,
                            LockoutEnabled = false,
                            NormalizedEmail = "CUSTOMER@BBA.CO.NZ",
                            NormalizedUserName = "CUSTOMER@BBA.CO.NZ",
                            PasswordHash = "AQAAAAEAACcQAAAAECZBRqi30AzlG3dOngNC74G7qp4lzOzHem7rq6nCwjK2YCn1TtUhk2nCGKxAz8Bx4g==",
                            PhoneNumberConfirmed = true,
                            SecurityStamp = "e1f55c3f-e2ae-4f99-8527-7f8974674a70",
                            TwoFactorEnabled = false,
